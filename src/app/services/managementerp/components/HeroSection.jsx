...
import ERPSYSTEM from "../../../../components/lotties/ERP.json";
...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full px-18 pt-40 md:pt-24  lg:px-20  bg-gradient-to-br from-white via-blue-50/30 to-white overflow-hidden">

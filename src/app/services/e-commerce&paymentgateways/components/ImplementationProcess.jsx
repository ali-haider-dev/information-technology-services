...
const ImplementationProcess = () => {
  const processSteps = [
    {
      ...
      description:
        "Analysis of your target markets, payment preferences, and compliance requirements.",
    },
    {
      title: "Gateway Integration",
      description:
        "Setup and configuration of payment gateways with testing and security validation.",
    },
    {
      title: "Platform Customization",
      description:
        "Custom storefront design, product catalog setup, and checkout flow optimization.",
    },
    {
      title: "Launch & Optimization",
      description:
        "Go-live support with ongoing monitoring, analytics, and conversion optimization.",
    },
  ];
  ...
  const pricingInfo = {
    ...
    description: "2.9% + $0.30 per transaction + monthly platform fee",
  };

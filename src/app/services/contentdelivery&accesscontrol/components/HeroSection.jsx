        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-md text-gray-600 leading-relaxed mb-8">
              Secure, scalable content delivery network with advanced access
              control systems for academic and professional publishers. Protect
              your intellectual property while providing seamless access to
